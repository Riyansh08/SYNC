...
let getUserMedia=()=>{
  if((video && videoAvailable)|| (audio && audioAvailable)){
    ...
    try{
   let tracks = localVideoRef.current.srcObject.getTracts();
   tracks.forEach(track=> track.stop());
    }catch(e){
...
let addMessage = (data, sender, socketIdSender) => {
  console.log("adding message", data , "sender" , sender);
  ...
  let getDisplayMedia =()=>{
    if(screen){
      if(navigator.mediaDevices.getDisplayMedia){
        navigator.mediaDevices.getDisplayMedia({video:true , audio : true}).then(getDislayMediaSuccess).then((stream)=>{
